...
public class testDecorador {
	...
	//	};
		Logica l = new Logica(); 
		ServicioCadena_Hotelera ServicioCadena_Hotelera = new ServicioCadena_Hotelera() {
			private static final long serialVersionUID = 1L;
		};
		Cadena_Hotelera cadenanueva = new Cadena_Hotelera();
		cadenanueva.setIdCadena_Hotelera(20);
		cadenanueva.setNombre("Campeonizar");
		cadenanueva.setHotels(new ArrayList<Hotel>());
		
		Hotel hotel = new Hotel();
		hotel.setCadenaHotelera(cadenanueva);
		hotel.setIdHotel(11);
		hotel.setNombre("Campeon2");
		...
		//ServicioCadena_Hotelera.borrar(10);
	//	l.AgregarHotelaCadena();
   /* //inicio
		...
		hotel.setCadenaHotelera(cadenanueva);
		hotel.setIdHotel(8);
		hotel.setNombre("Tambores");
		hotel.setUbicacion("Limon");
		
		hotels.insertar(hotel);
	//fin*/
		...
		//inicio
				...
				System.out.print(""+cadenanueva2.getNombre());
				List<Hotel> hoteles2 = cadenanueva2.getHotels();
				Hotel hotel2 = new Hotel();
				hotel2.setCadenaHotelera(cadenanueva2);
				hotel2.setIdHotel(9);
				hotel2.setNombre("crayon");
		...
		*/
		...
		/*cadena2.startEntityManager();
		Cadena_Hotelera cadenanueva= new Cadena_Hotelera();
		Hotel hotel = new Hotel();
		hotel.setCadenaHotelera(cadenanueva);
		hotel.setIdHotel(1);
		hotel.setNombre("Tambor");
		hotel.setUbicacion("Puntarenas");
		cadenanueva= cadena2.buscar(cadenanueva, 1);
		cadenanueva.addHotel(hotel);
		cadena2.actualizar(cadenanueva);
