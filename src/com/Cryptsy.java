...
public class Cryptsy {
    ...
    public PublicMarket[] getSingleMarketData() throws CryptsyException {
        String results = request(PUB_API_URL + "?method=singlemarketdata&marketid=135");
        PublicMarketData md = gson.fromJson(results, PublicMarketData.class);
        return md.info.markets;
    }
    ...
    public Trade[] getMarketTrades(int market_id) throws CryptsyException {
        ...
        for (int i = 0; i < trades.trades.length; i++) {
            trades.trades[i].marketid = market_id;
        }
    ...
    public long[] cancelMarketOrders(int market_id) throws CryptsyException {
        ...
        if (r.success == 1 && r.info != null) {
            ...
            for (int i = 0; i < orderids.length; i++) {
                ...
                if (m.find()) {
                    orderids[i] = Long.parseLong(m.group(0));
                }
            }
        }
        return orderids;
     ...
     * @param secret the secret obtained from Profile->API Keys in your BTC-E
     * account.
     */
    ...
    public static class Currencies {
        ...
        public static final String AuroraCoin = "AUR";
        public static final String BBQCoin = "BQC";
        public static final String BattleCoin = "BCX";
        public static final String Benjamins = "BEN";
        ...
        public static final String CACHeCoin = "CACH";
        public static final String CHNCoin = "CNC";
        public static final String CashCoin = "CASH";
        ...
        public static final String DarkCoin = "DRK";
        ...
        public static final String FlappyCoin = "FLAP";
        ...
        public static final String KittehCoin = "MEOW";
        public static final String KrugerCoin = "KGC";
        public static final String LeafCoin = "LEAF";
        ...
        public static final String MaxCoin = "MAX";
        public static final String MazaCoin = "MZC";
        public static final String MegaCoin = "MEC";
        public static final String MemeCoin = "MEM";
        public static final String MinCoin = "MNC";
        public static final String MintCoin = "MINT";
        ...
        public static final String SmartCoin = "SMC";
        ...
        public static final String TakeiCoin = "TAK";
        ...
        public static final String UltraCoin = "UTC";
        public static final String Unobtanium = "UNO";
        public static final String VertCoin = "VTC";
        ...
        public static final String ZcCoin = "ZCC";
    ...
    public static class Markets {
        ...
        public static final int AUR_BTC = 160;
        public static final int AUR_LTC = 161;
        public static final int BCX_BTC = 142;
        public static final int BEN_BTC = 157;
        ...
        public static final int CACH_BTC = 154;
        public static final int CAP_BTC = 53;
        public static final int CASH_BTC = 150;
        ...
        public static final int DRK_BTC = 155;
        ...
        public static final int EZC_BTC = 47;
        public static final int EZC_LTC = 55;
        public static final int FFC_BTC = 138;
        public static final int FLAP_BTC = 165;
        ...
        public static final int MAX_BTC = 152;
        public static final int MEC_BTC = 45;
        public static final int MEC_LTC = 100;
        public static final int MEM_LTC = 56;
        public static final int MEOW_BTC = 149;
        public static final int MINT_BTC = 156;
        ...
        public static final int MZC_BTC = 164;
        ...
        public static final int NXT_BTC = 159;
        public static final int NXT_LTC = 162;
        ...
        public static final int UTC_BTC = 163;
        public static final int VTC_BTC = 151;
    ...
    static {
        ...
        CurrencyNames.put("AUR", "AuroraCoin");
        CurrencyNames.put("BCX", "BattleCoin");
        CurrencyNames.put("BEN", "Benjamins");
        ...
        CurrencyNames.put("CACH", "CACHeCoin");
        CurrencyNames.put("CAP", "BottleCaps");
        CurrencyNames.put("CASH", "CashCoin");
        ...
        CurrencyNames.put("DRK", "DarkCoin");
        ...
        CurrencyNames.put("FLAP", "FlappyCoin");
        ...
        CurrencyNames.put("LEAF", "LeafCoin");
        ...
        CurrencyNames.put("SMC", "SmartCoin");
        ...
        CurrencyNames.put("TAK", "TakeiCoin");
        ...
        CurrencyNames.put("UTC", "UltraCoin");
        CurrencyNames.put("VTC", "VertCoin");
