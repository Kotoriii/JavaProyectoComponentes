...
<%
	entidades.Usuario usuario = new entidades.Usuario();//se usa un constructor vacio para evitar nullPointerException
	if (request.getSession().getAttribute("usuario") != null) {
		usuario = (entidades.Usuario) request.getSession()
		...
		<div class="container-fluid">
			...
			<div class="navbar-header">
				<button type="button" class="navbar-toggle" data-toggle="collapse"
					...
					<span class="sr-only">Tipo de navegacion</span> <span
						class="icon-bar"></span> <span class="icon-bar"></span> <span
						class="icon-bar"></span>
				</button>
				<a class="navbar-brand" href="index.jsp" style='color: #F7E136;'><strong>DogeMine</strong></a>
			</div>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <!-- 
>>>>>>> b95e51431bfc90c7ee5062a21b38438526131175
                        <li><a href="#">Link</a></li>
                        <li class="dropdown">
...
<<<<<<< HEAD
	...
	<div id="popover"
		style="z-index: 10; position: fixed; bottom: 290px; right: 70px; width: 300px; height: 150px; background-color: #F7E136;; border-radius: 50px; visibility: hidden; opacity: 0.8">
		<h2 id="poptext" style="text-align: center; margin-top: 20%">such
			popover</h2>
	</div>
	<div id="doge"
		style="width: 300px; height: 350px; position: fixed; bottom: -220px; right: 100px; z-index: 300;">
	...
	<script type="text/javascript">
		...
		$('#doge').mouseenter(
				function() {
					$('#doge').css("bottom", "-220px").css("transition",
							"all 0.4s ease") // you may also (-moz-*, -o-*, -ms-*) e.g
		...
		$('#doge').mouseleave(
				function() {
					$('#doge').css("bottom", "-50px").css("transition",
							"all 0.4s ease") // you may also (-moz-*, -o-*, -ms-*) e.g
					.css("bottom", "-100px").delay(10).queue(function() {
